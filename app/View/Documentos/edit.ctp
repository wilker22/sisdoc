...
echo $this->Form->create('Documento'); ?>
	<fieldset>
		<legend><?php echo __('Editar Documento'); ?></legend>
<?php
...
<div class="actions">
	...
	<ul>
		...
		<!--<li><?php echo $this->Form->postLink(__('Remover'), array('action' => 'delete', $this->Form->value('Documento.id')), null, __('Tem certeza que deseja remover # %s?', $this->Form->value('Documento.id'))); ?></li>-->
